<?php
    ...
    if(isset($_POST['btn-updateDentist']))
    {
        ...
        {
            redirect('../../MainUI/StaffUI/update_dentists.php?id='.$dentist_id, 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            {
               redirect('../../MainUI/StaffUI/dentists.php', '', "You've modified dentist successfully!");
            }
            else
            {
                redirect('../../MainUI/StaffUI/update_dentists.php?id='.$dentist_id, 'Something went wrong! Please enter again...', "");
            }
        }
    }
?>