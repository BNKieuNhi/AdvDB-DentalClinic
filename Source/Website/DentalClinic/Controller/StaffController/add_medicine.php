    ...
    if(isset($_POST['btn-add-medicine']))
    {
        ...
        if(!empty($medname) && !empty($price) && $price > 0)
        {
            ...
            if($addmedicine['status'])
            {
                ...
                redirect('../../MainUI/StaffUI/medicines.php', '', "You've added customer successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/StaffUI/add_medicines.php', 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/StaffUI/add_medicines.php', 'All fields are required.', '');
            exit(0);                            
        }
    }
?>