<?php
    ...
    if(is_numeric($param))
    {
        ...
        {
           redirect('../../MainUI/StaffUI/dentists.php', $dentist['status'], '');
        }
        else
        {
            //echo "Here";
            ...
            {
                redirect('../../MainUI/StaffUI/dentists.php', '', "You've deleted dentist {$dentist['data']['fullname']} !");
            }
            else
            {
                redirect('../../MainUI/StaffUI/dentists.php', 'Cannot delete. Please try again!', '');
            }
        }
    ...
    {
        redirect('../../MainUI/StaffUI/dentists.php', 'Something went wrong. Please try again!', '');
    }
?>