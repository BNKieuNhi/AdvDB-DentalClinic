    ...
    if(isset($_POST['btn-add-dentist']))
    {
        ...
        !empty($address)  && !empty($username) && !empty($password))
        {
            ...
            if($addAccount['status'] && $addUser['status'])
            {
                ...
                redirect('../../MainUI/StaffUI/dentists.php', '', "You've added dentist successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/StaffUI/add_dentists.php', 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/StaffUI/add_dentists.php', 'All fields are required.', '');
            exit(0);                            
        }
    }
?>