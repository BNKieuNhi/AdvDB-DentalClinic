    ...
    if(isset($_POST['btn-add-staff']))
    {
        ...
        !empty($address)  && !empty($username) && !empty($password))
        {
            ...
            if($addAccount['status'] && $addUser['status'])
            {
                ...
                redirect('../../MainUI/StaffUI/staffs.php', '', "You've added staff successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/StaffUI/add_staffs.php', 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/StaffUI/add_staffs.php', 'All fields are required.', '');
            exit(0);                            
        }
    }
?>