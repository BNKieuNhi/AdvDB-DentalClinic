<?php
    ...
    if(isset($_POST['btn-updateStaff']))
    {
        ...
        {
            redirect('../../MainUI/StaffUI/update_staffs.php?id='.$staff_id, 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            {
                redirect('../../MainUI/StaffUI/staffs.php', '', "You've modified staff successfully!");
            }
            else
            {
                redirect('../../MainUI/StaffUI/update_staffs.php?id='.$staff_id, 'Something went wrong! Please enter again...', "");
            }
        }
    }
?>