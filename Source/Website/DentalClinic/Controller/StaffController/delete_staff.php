<?php
    ...
    if(is_numeric($param))
    {
        ...
        {
           redirect('../../MainUI/StaffUI/staffs.php', $staff['status'], '');
        }
        else
        {
            // echo "Here";
            ...
            {
                redirect('../../MainUI/StaffUI/staffs.php', '', "You've deleted staff {$staff['data']['fullname']} !");
            }
            else
            {
                redirect('../../MainUI/StaffUI/staffs.php', 'Cannot delete. Please try again!', '');
            }
        }
    ...
    {
        redirect('../../MainUI/StaffUI/staffs.php', 'Something went wrong. Please try again!', '');
    }
?>