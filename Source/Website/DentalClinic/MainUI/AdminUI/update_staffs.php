                                ...
                                <div class="form-row">
                                    <div class="form-row__flex">
                                        ...
                                        <div class="form-col">
                                            ...
                                            <select name="staff_gender" id="ptGender" class="form-cotrol" onchange="getCustomer(this.value)">
                                ...
                                <div class="form-row">
                                    <div class="form-col margin-0">
                                        <div class="form-col-bottom">
                                            <input type="submit" name="addStaff" value="Update Staff" class="btn-control btn-control-add" value="">
                                        </div>
                                    </div>
                                </div>
